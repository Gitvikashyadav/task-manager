        ...
        <div className="bg-[#111827] border border-white/[0.07] rounded-2xl p-10 shadow-2xl">
          <div className="flex items-center gap-3 mb-10">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center shadow-[0_0_24px_rgba(56,189,248,0.3)]">
              <span className="font-display font-black text-base text-[#080c14]">TF</span>
            </div>
          ...
          <h1 className="font-display font-bold text-2xl text-slate-100 mb-1.5 tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? (
                <><span className="w-4 h-4 rounded-full border-2 border-sky-900/30 border-t-[#080c14] spinner inline-block" />Signing in...</>
              ) : (
